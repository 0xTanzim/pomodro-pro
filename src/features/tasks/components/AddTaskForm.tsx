  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formData.title.trim()) {
      onAdd({
        ...
        pomodoroDuration: Math.max(1, Math.round(formData.pomodoroDuration)),
        shortBreakDuration: Math.max(
          1,
          Math.round(formData.shortBreakDuration)
        ),
        longBreakDuration: Math.max(1, Math.round(formData.longBreakDuration)),
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData((prev) => ({
                ...prev,
                pomodoros: parseInt(e.target.value) || 1,
              }))
            }
          />
        </div>
